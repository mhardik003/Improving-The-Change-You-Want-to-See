...
class CenterNetWithCoAttention(pl.LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument("--encoder", type=str, choices=["resnet50", "resnet18", "resnext50_32x4d"])
    ...
    def test_epoch_end(self, multiple_test_set_outputs):
        ...
        for test_set_name, test_set_batch_outputs in zip(
            ...
            # log the mAP on wandb
            self.log(
                f"test/{test_set_name}_mAP",
                ap_map_precision_recall["map"],
                on_epoch=True,
            )
